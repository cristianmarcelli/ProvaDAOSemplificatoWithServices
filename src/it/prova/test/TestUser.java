...
//			System.out.println("In tabella ci sono " + userService.listAll().size() + " elementi.");
	...
	private static void testCercaTuttiQuelliCheUsernameIniziaCon(UserService userService) throws Exception {
		System.out.println(".......cercaTuttiQuelliCheUsernameIniziaCon inizio.............");

		// creazione lista user che sarà il result
		List<User> result = userService.cercaTuttiQuelliCheUsernameIniziaCon("l");

		if (result.size() == 0) {
			throw new RuntimeException("cercaTuttiQuelliCheUsernameIniziaCon FAILED ");
		}
